      ...
      <nav class="navbar navbar-expand">
       ...
       <aside class="sidebar-wrapper" data-simplebar="true">
          ...
          <ul class="metismenu" id="menu">
            ...
            <li class="menu-label">Smart Zambia HQ Assests</li>
            <li>
              <a href="javascript:;" class="has-arrow">
                <div class="parent-icon"><i class="bi bi-award"></i>
                </div>
                <div class="menu-title">Systems Development</div>
              </a>
              <ul>
                <li> <a href="list-computers" name="command" value="List">
                <input type="hidden" name="command" value="List">
                <i class="bi bi-arrow-right-short"></i>Computers</a>
                </li>
       ...
       <main class="page-content">
				...
				<div class="card">
					<div class="card-body">
						...
						<div class="row gy-3">
							<div class="col-md-2 text-end d-grid">
								<button type="button" onclick="windows.location.href="list-computer-form.jsp"; return false"; class="btn btn-primary">Add Computer</button>
							</div>
						</div>
					...
					<div id="wrappper">
							...
							<c:forEach var="tempComputer" items="${COMPUTER_LIST }" >  
							
							
							
							 
							    <tr>
							      <td>${tempComputer.computerModel}</td>
							      <td>${tempComputer.computerNumber}</td>
							      <td>${tempComputer.computerYear}</td>
							      <td><a href="${ update_Link}">Update</a><a href="${delete_link }" 
